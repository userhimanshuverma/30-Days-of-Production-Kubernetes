# ðŸ“– Day-27 - Running Data Platforms on Kubernetes
### ðŸ·ï¸ PHASE 4 - ADVANCED CLOUD-NATIVE ENGINEERING

> **TL;DR:** Spark operator, Apache Airflow scheduling, Apache Kafka cluster running stateful configurations.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **Running Data Platforms on Kubernetes**.
