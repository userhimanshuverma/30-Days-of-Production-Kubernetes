# ðŸ“– Day-22 - Kubernetes Scheduler Internals
### ðŸ·ï¸ PHASE 4 - ADVANCED CLOUD-NATIVE ENGINEERING

> **TL;DR:** Node affinity/anti-affinity, pod affinity/anti-affinity, taints, tolerations, and custom schedulers.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **Kubernetes Scheduler Internals**.
