# ðŸ“– Day-12 - Resource Management and Scheduling
### ðŸ·ï¸ PHASE 2 - RUNNING REAL APPLICATIONS

> **TL;DR:** CPU/Memory requests and limits, QoS classes (Guaranteed, Burstable, BestEffort), and Scheduler bin-packing.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **Resource Management and Scheduling**.
