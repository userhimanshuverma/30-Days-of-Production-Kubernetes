# ðŸ“– Day-10 - Ingress and Traffic Routing
### ðŸ·ï¸ PHASE 2 - RUNNING REAL APPLICATIONS

> **TL;DR:** Ingress controllers, Ingress resources, TLS termination, and path-based routing.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **Ingress and Traffic Routing**.
