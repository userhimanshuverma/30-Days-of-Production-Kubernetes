# ðŸ“– Day-18 - Distributed Tracing and OpenTelemetry
### ðŸ·ï¸ PHASE 3 - OBSERVABILITY AND PRODUCTION OPERATIONS

> **TL;DR:** OpenTelemetry collector, Jaeger, distributed context propagation, tracing microservices.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **Distributed Tracing and OpenTelemetry**.
