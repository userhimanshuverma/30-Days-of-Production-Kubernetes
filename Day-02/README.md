# ðŸ“– Day-02 - Containers Deep Dive
### ðŸ·ï¸ PHASE 1 - FOUNDATIONS OF CLOUD-NATIVE SYSTEMS

> **TL;DR:** Namespaces, cgroups, runtimes (containerd), OCI standards, and container internals.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **Containers Deep Dive**.
