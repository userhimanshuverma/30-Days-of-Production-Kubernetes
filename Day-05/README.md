# ðŸ“– Day-05 - Deployments, ReplicaSets and Rollouts
### ðŸ·ï¸ PHASE 1 - FOUNDATIONS OF CLOUD-NATIVE SYSTEMS

> **TL;DR:** Desired state model, self-healing, rolling updates, canary releases, and rollbacks.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **Deployments, ReplicaSets and Rollouts**.
