# ðŸ“– Day-15 - Kubernetes Security Fundamentals
### ðŸ·ï¸ PHASE 2 - RUNNING REAL APPLICATIONS

> **TL;DR:** RBAC (Roles, bindings), Service Accounts, Pod Security Standards (PSS/PSA), and Admission Control.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **Kubernetes Security Fundamentals**.
