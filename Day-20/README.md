# ðŸ“– Day-20 - CI/CD for Kubernetes
### ðŸ·ï¸ PHASE 3 - OBSERVABILITY AND PRODUCTION OPERATIONS

> **TL;DR:** GitOps workflows, ArgoCD setup, declarative applications, sync strategies, and PR pipelines.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **CI/CD for Kubernetes**.
