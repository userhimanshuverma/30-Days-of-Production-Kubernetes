# ðŸ“– Day-19 - Debugging Kubernetes Like a Production Engineer
### ðŸ·ï¸ PHASE 3 - OBSERVABILITY AND PRODUCTION OPERATIONS

> **TL;DR:** CrashLoopBackOff, OOMKilled, ImagePullBackOff, network trace tools, ephemeral debug containers.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **Debugging Kubernetes Like a Production Engineer**.
