# ðŸ“– Day-06 - Services and Networking Fundamentals
### ðŸ·ï¸ PHASE 1 - FOUNDATIONS OF CLOUD-NATIVE SYSTEMS

> **TL;DR:** ClusterIP, NodePort, LoadBalancer, DNS, service discovery, and kube-proxy internals.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **Services and Networking Fundamentals**.
