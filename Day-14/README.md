# ðŸ“– Day-14 - Kubernetes Networking Internals
### ðŸ·ï¸ PHASE 2 - RUNNING REAL APPLICATIONS

> **TL;DR:** CNI interfaces, overlay networks, Calico, network policies, and pod-to-pod packet flow.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **Kubernetes Networking Internals**.
