# ðŸ“– Day-21 - Backup, Disaster Recovery and High Availability
### ðŸ·ï¸ PHASE 3 - OBSERVABILITY AND PRODUCTION OPERATIONS

> **TL;DR:** etcd snapshotting and restore, Velero backups, multi-zone topology spread, HA control plane.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **Backup, Disaster Recovery and High Availability**.
