# ðŸ“– Day-08 - Persistent Storage and Volumes
### ðŸ·ï¸ PHASE 2 - RUNNING REAL APPLICATIONS

> **TL;DR:** PV, PVC, CSI specifications, storage classes, and local/cloud storage management.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **Persistent Storage and Volumes**.
