# ðŸ“– Day-01 - Why Kubernetes Changed Infrastructure Forever
### ðŸ·ï¸ PHASE 1 - FOUNDATIONS OF CLOUD-NATIVE SYSTEMS

> **TL;DR:** Evolution from bare metal to containers, container orchestration needs, and K8s value.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **Why Kubernetes Changed Infrastructure Forever**.
