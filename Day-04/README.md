# ðŸ“– Day-04 - Pods Explained Properly
### ðŸ·ï¸ PHASE 1 - FOUNDATIONS OF CLOUD-NATIVE SYSTEMS

> **TL;DR:** Lifecycle, init containers, sidecars, multi-container patterns, and runtime specs.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **Pods Explained Properly**.
