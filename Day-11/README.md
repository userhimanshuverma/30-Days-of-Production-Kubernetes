# ðŸ“– Day-11 - Helm Deep Dive
### ðŸ·ï¸ PHASE 2 - RUNNING REAL APPLICATIONS

> **TL;DR:** Helm chart anatomy, templating, dry-runs, upgrades, and chart repositories.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **Helm Deep Dive**.
