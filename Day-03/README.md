# ðŸ“– Day-03 - Kubernetes Architecture Internals
### ðŸ·ï¸ PHASE 1 - FOUNDATIONS OF CLOUD-NATIVE SYSTEMS

> **TL;DR:** API Server, Scheduler, Controller Manager, etcd, kubelet, and kube-proxy flows.

---

## ðŸŽ¯ Learning Objectives
By the end of this day, you will be able to:
1. Explain the architectural concepts of **Kubernetes Architecture Internals**.
